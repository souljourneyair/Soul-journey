...
const BUILDINGS = {
  ...
  tower: {
    ...
    desc: 'Улучшает пропускную способность аэропорта — задаёт интервал между приёмом и выпуском бортов. Чем выше уровень, тем чаще операции. Обязательна для полётов своих самолётов.',
  },
  runway_small: {
    ...
    desc: 'Принимает лёгкие самолёты внутренних авиалиний (ВВЛ). Нужна для взлёта и посадки.',
  },
  terminal_a: {
  ...
  runway_full: {
    ...
    desc: 'Принимает малые и средние самолёты внутренних и международных авиалиний (ВВЛ+МВЛ).',
  },
  cargo_terminal: {
  ...
  runway_big: {
    ...
    isRunway: true, lineType: 'both',
    desc: 'Принимает малые, средние и большие самолёты внутренних и международных авиалиний (ВВЛ+МВЛ).',
  },
  vip_lounge: {
