...
function renderEconomy() {
  ...
  $('#econHint').textContent =
    ...
    + 'Цены обновляются каждый игровой час; уровень заметно (до ±2%) двигается не чаще '
    + 'двух раз в неделю, а серьёзные ЧС поднимают его на 3–7%. '
    + 'Колебания меньше 1% экономику не затрагивают. Пунктир — базовая цена.';
}
