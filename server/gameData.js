...
const BUILDINGS = {
  ...
  runway_small: {
    ...
    surfaceByLevel: [
      'грунтовая полоса, без оснащения',
      'гравий, без оснащения',
      'бетон, рулёжные огни',
      'асфальт, глиссада и огни PAPI',
      'современное покрытие, оснащение по последнему слову техники',
    ],
  ...
  runway_full: {
    ...
    surfaceByLevel: [
      'бетон, рулёжные огни',
      'бетон на гравийной подушке, рулёжные огни',
      'асфальт, рулёжные и осевые огни',
      'многослойная ВПП, глиссада и огни PAPI',
      'современное покрытие, оснащение по последнему слову техники',
    ],
