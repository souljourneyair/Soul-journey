...
const CONFIG = {
  ...
  MAX_GRID_SIZE: 12,       // максимум 12x12 = 144 клетки после всех покупок земли
...
const LAND_EXPANSION = [
  ...
  // Четвёртая ступень: 8x8 -> 10x10, +36 клеток. Добавлена вместе с
  // продлением лестницы опыта до 40 уровня — раньше на 8x8 (64 клетки)
  // упирался потолок территории, а игра теперь идёт значительно дальше.
  { cost: 90000, minLevel: 12 },
];
